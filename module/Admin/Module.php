...
use Application\Model\VehicleBrandsTable;
...
use Application\Service\VehicleBrandsService;
    ...
    public function getServiceConfig()
    {
        return array(
            'factories' => array(
                ...
                'VehicleBrandsTable' => function ($sm) {
                    $dbAdapter = $sm->get('Zend\Db\Adapter\Adapter');
                    $table = new VehicleBrandsTable($dbAdapter);
                    return $table;
                },
                ...
                'VehicleBrandsService' => function ($sm) {
                    return new VehicleBrandsService($sm);
                },
