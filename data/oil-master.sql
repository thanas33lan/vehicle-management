...
CREATE TABLE `category` (
  ...
  `vb_name` varchar(255) DEFAULT NULL,
  `vb_slug` varchar(255) DEFAULT NULL,
  `description` text,
  `image` varchar(255) DEFAULT NULL,
  `parent_id` int(11) NOT NULL DEFAULT '0',
  `vb_status` varchar(255) NOT NULL DEFAULT 'inactive' COMMENT 'active, inactive',
...
INSERT INTO `category` (`vb_id`, `vb_name`, `vb_slug`, `description`, `image`, `parent_id`, `vb_status`, `created_on`, `created_by`, `modified_on`, `modified_by`) VALUES
...
--
ALTER TABLE `category`
  MODIFY `vb_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
